    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                //close the election and set member post_title
                $sql = " UPDATE cms_election SET STATUS = 'CLOSE',winner = '".$_GET['username']."' WHERE id = ".$_GET['eid']; 
                setUpdate($sql, TRUE);
                $sqlMem = " UPDATE cms_member SET post_title = '".$_GET['post_title']."' WHERE username = '".$_GET['username']."' ";
                setUpdate($sql, FALSE);
                ?>
